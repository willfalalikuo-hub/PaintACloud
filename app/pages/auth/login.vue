<template>
  <div class="min-h-screen flex items-center justify-center bg-[var(--color-warm-bg)] p-4">
    <div class="w-full max-w-sm">
      ...
      <div class="bg-white rounded-2xl p-6 shadow-sm">
        ...
        <form @submit.prevent="handleSubmit" class="space-y-4">
          <div v-if="isRegister">
            ...
            <input v-model="nickname" type="text" required
              class="w-full px-4 py-2.5 rounded-xl border border-gray-200 focus:border-coral focus:outline-none text-sm"
              placeholder="你的昵称" />
          </div>
        ...
        <div class="text-center mt-4">
          <button @click="isRegister = !isRegister" class="text-sm text-gray-400 hover:text-coral transition-colors">
